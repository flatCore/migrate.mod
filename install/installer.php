...
if(!is_file("$mod_db")) {
	...
	$sql_entries_table = generate_sql_query("../modules/migrate.mod/install/tpl-entries.php");
	$sql_prefs_table = generate_sql_query("../modules/migrate.mod/install/tpl-preferences.php");
